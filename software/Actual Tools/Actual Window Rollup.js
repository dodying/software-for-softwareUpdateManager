...
let data = {
  ...
  version: {
    selector: 'div.header > table:nth-child(5) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2) > b:nth-child(1)'
  },
  download: {
    plain: 'https://www.actualtools.com/files/awrsetup.exe'
  },
